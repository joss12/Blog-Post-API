...
const hashPassword = require("../utils/passwordSystem");
const comparePassword = require("../utils/comparePasswordSystem");
const generateToken = require("../utils/TokenSystem");
const generateCode = require("../utils/generateSystem");
...
signup = async (req, res, next) => {
  try {
    ...
    if (isEmailExist) {
      res.code = 400;
      throw new Error("This mail already taken");
    }
